      ...
      <Center>
        <HStack w="80%" py="70px" spacing={9}>
          ...
          <Box>
            <VStack spacing={8}>
              <Text>
                Smallholder farmers are uniquely poised to implement the changes
                agriculture needs to become truly sustainable and regenerative,
                and to help fix our food system globally.{" "}
              </Text>
              <Text>
                We are committed to supporting rural communities with resources,
                training, project implementation and coaching. Your contribution
                of <span style={{ fontSize: "20px" }}>$30</span>,{" "}
